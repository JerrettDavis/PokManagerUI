...
/// <summary>
/// Validator for SaveWorldRequest to ensure all required fields are valid.
/// </summary>
public class SaveWorldRequestValidator : AbstractValidator<SaveWorldRequest>
{
    public SaveWorldRequestValidator()
    {
